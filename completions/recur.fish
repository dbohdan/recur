...
complete -c recur -s r -l reset -x -d "Minimum attempt time that resets exponential and Fibonacci backoff" -a "5s 1m 5m 30m 1h"
complete -c recur -s s -l seed -x -d "Random seed for jitter" -a "0 123"
